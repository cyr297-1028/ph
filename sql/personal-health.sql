...
create table face(
    ...
    vef_num int COMMENT '验证码的验证次数',
    face_name varchar(255) COMMENT '人脸图片对应的用户名称',
    remark varchar(255) COMMENT '备注',
    face_status int COMMENT '人脸图片的审核状态，0为可用，1为不可用',
...
INSERT INTO `health_model_config` VALUES (11, 3, '晨间血糖浓度', '这是测试的', '/api/personal-heath/v1.0/file/getFile?fileName=c501abd转氨酶.png', 'mol', '摩尔/升', 0, '10,50');
INSERT INTO `health_model_config` VALUES (12, 3, '夜间平均心率', '测试数据', '/api/personal-heath/v1.0/file/getFile?fileName=71743b6心率.png', '次', '暂无', 0, '80,110');
...
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES (19, '你记录的【晨跑步数】超标了，正常值范围:[3000,10000]，请注意休息。必要时请就医!', 3, 3, NULL, 1, NULL, '2025-04-22 16:17:19');
INSERT INTO `message` VALUES (25, '你记录的【晨跑步数】超标了，正常值范围:[3000,10000]，请注意休息。必要时请就医!', 3, 22, NULL, 0, NULL, '2025-04-22 17:27:24');
...
CREATE TABLE `score`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '评分ID，主键',
  `user_id` int(11) NULL DEFAULT NULL COMMENT '用户ID',
  `article_id` int(11) NULL DEFAULT NULL COMMENT '物品ID',
  `total` int(11) NULL DEFAULT NULL COMMENT '评分分数',
...
CREATE TABLE `user_health`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 101 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '用户健康记录表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user_health` VALUES (89, 3, 13, '36.7', '2025-04-21 17:20:26');
INSERT INTO `user_health` VALUES (90, 3, 13, '36.8', '2025-04-21 17:20:50');
INSERT INTO `user_health` VALUES (91, 3, 13, '77.1', '2025-04-21 17:21:00');
INSERT INTO `user_health` VALUES (92, 3, 10, '4000', '2025-04-22 16:16:45');
INSERT INTO `user_health` VALUES (93, 3, 9, '422', '2025-04-22 16:16:45');
INSERT INTO `user_health` VALUES (94, 3, 10, '13000', '2025-04-22 16:17:19');
